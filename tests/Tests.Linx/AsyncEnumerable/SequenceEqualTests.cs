...
//        {
//            var i1 = TestSequence.Parse("-a- b-  c-|");
//            var i2 = TestSequence.Parse(" a--b---c|");
//            var i3 = TestSequence.Parse("-a- b-  c-d");
...
//            var i2 = TestSequence.Parse(" a--b---c#");
//            var i3 = TestSequence.Parse("-a- b-  c-d#");
//            await Assert.ThrowsAsync<TestException>(() => VirtualTime.Run(() => i1.SequenceEqual(i2, default)));
//            Assert.False((await VirtualTime.Run(() => i1.SequenceEqual(i3, default))).Value);
//        }
...
//        {
//            var i1 = TestSequence.Parse(" -a-bc");
//            var i2 = TestSequence.Parse("a- -b ---c---#");
//            await TestSequence.AssertCancel(t => i1.SequenceEqual(i1, t), TimeSpan.FromHours(1));
//            await TestSequence.AssertCancel(t => i1.SequenceEqual(i2, t), TimeSpan.FromSeconds(7));
//        }
//    }
//}
