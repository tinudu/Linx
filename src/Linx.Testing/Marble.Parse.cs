namespace Linx.Testing
{
    ...
    /// <summary>
    /// Static <see cref="IMarbleDiagram{T}"/> methods.
    /// </summary>
    /// <remarks>
    /// Parse syntax (spaces are ignored):
    /// <code>
    ...
    public static partial class Marble
    {
        ...
        public static IMarbleDiagram<char> Parse(
        ...
        /// <param name="settings">Optional. Marble parser settings.</param>
        public static IMarbleDiagram<T> Parse<T>(
            IEnumerable<char> diagram,
            ...
            MarbleSettings settings = null)
        {
            ...
            try
            {
                ...
                return new MarbleDiagram<T>(notifications);
            }
