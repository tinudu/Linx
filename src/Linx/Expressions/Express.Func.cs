namespace Linx.Expressions
{
    ...
    partial class Express
    {
        ...
        /// </summary>
        /// <returns><paramref name="func"/></returns>
        public static Func<T1, TResult> Func<T1, TResult>(Func<T1, TResult> func) => func;

        /// <summary>
        /// Convenience function to infer the result type.
        /// </summary>
        /// <returns><paramref name="func"/></returns>
        public static Expression<Func<T1, TResult>> FuncX<T1, TResult>(Expression<Func<T1, TResult>> func) => func;
