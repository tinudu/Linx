namespace Linx.Reactive
{
    ...
    partial class LinxReactive
    {
        ...
        /// </summary>
        public static IAsyncEnumerableObs<TSource> Catch<TSource, TException>(this IAsyncEnumerableObs<TSource> source, Action<TException> handler) where TException : Exception
        {
