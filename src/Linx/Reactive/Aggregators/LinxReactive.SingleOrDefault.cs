namespace Linx.Reactive
{
    ...
    partial class LinxReactive
    {
        ...
        /// </summary>
        public static async Task<T> SingleOrDefault<T>(this IAsyncEnumerableObs<T> source, CancellationToken token)
        {
        ...
        /// </summary>
        public static async Task<T> SingleOrDefault<T>(this IAsyncEnumerableObs<T> source, Func<T, bool> predicate, CancellationToken token)
