namespace Linx.Reactive
{
    ...
    partial class LinxReactive
    {
        ...
        public static async Task<T> Min<T>(this IAsyncEnumerableObs<T> source, IComparer<T> comparer, CancellationToken token)
        {
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">Sequence contains no non-null elements.</exception>
        public static async Task<T> Min<T>(this IAsyncEnumerableObs<T> source, CancellationToken token)
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">Sequence contains no non-null elements.</exception>
        public static async Task<TResult> Min<TSource, TResult>(this IAsyncEnumerableObs<TSource> source, Func<TSource, TResult> selector, CancellationToken token)
        ...
        /// </summary>
        public static async Task<T> MinOrDefault<T>(this IAsyncEnumerableObs<T> source, IComparer<T> comparer, CancellationToken token)
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            if (comparer == null) comparer = Comparer<T>.Default;
        ...
        /// Returns the minimum non-null element of a sequence, or a default value if the sequence contains no non-null elements.
        /// </summary>
        public static async Task<T> MinOrDefault<T>(this IAsyncEnumerableObs<T> source, CancellationToken token)
        ...
        /// </summary>
        public static async Task<TResult> MinOrDefault<TSource, TResult>(this IAsyncEnumerableObs<TSource> source, Func<TSource, TResult> selector, CancellationToken token)
        ...
        /// </summary>
        public static async Task<T?> MinOrNull<T>(this IAsyncEnumerableObs<T> source, IComparer<T> comparer, CancellationToken token) where T : struct
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            if (comparer == null) comparer = Comparer<T>.Default;
        ...
        /// Returns the minimum element of a sequence, or null if the sequence contains no elements.
        /// </summary>
        public static async Task<T?> MinOrNull<T>(this IAsyncEnumerableObs<T> source, CancellationToken token) where T : struct
        ...
        /// </summary>
        public static async Task<TResult?> MinOrNull<TSource, TResult>(this IAsyncEnumerableObs<TSource> source, Func<TSource, TResult> selector, CancellationToken token) where TResult : struct
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">Sequence contains no non-null elements.</exception>
        public static async Task<T> Max<T>(this IAsyncEnumerableObs<T> source, IComparer<T> comparer, CancellationToken token)
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            if (comparer == null) comparer = Comparer<T>.Default;
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">Sequence contains no non-null elements.</exception>
        public static async Task<T> Max<T>(this IAsyncEnumerableObs<T> source, CancellationToken token)
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">Sequence contains no non-null elements.</exception>
        public static async Task<TResult> Max<TSource, TResult>(this IAsyncEnumerableObs<TSource> source, Func<TSource, TResult> selector, CancellationToken token)
        ...
        /// </summary>
        public static async Task<T> MaxOrDefault<T>(this IAsyncEnumerableObs<T> source, IComparer<T> comparer, CancellationToken token)
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            if (comparer == null) comparer = Comparer<T>.Default;
        ...
        /// Returns the maximum non-null element of a sequence, or a default value if the sequence contains no non-null elements.
        /// </summary>
        public static async Task<T> MaxOrDefault<T>(this IAsyncEnumerableObs<T> source, CancellationToken token)
        ...
        /// </summary>
        public static async Task<TResult> MaxOrDefault<TSource, TResult>(this IAsyncEnumerableObs<TSource> source, Func<TSource, TResult> selector, CancellationToken token)
        ...
        /// </summary>
        public static async Task<T?> MaxOrNull<T>(this IAsyncEnumerableObs<T> source, IComparer<T> comparer, CancellationToken token) where T : struct
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            if (comparer == null) comparer = Comparer<T>.Default;
        ...
        /// Returns the maximum element of a sequence, or null if the sequence contains no elements.
        /// </summary>
        public static async Task<T?> MaxOrNull<T>(this IAsyncEnumerableObs<T> source, CancellationToken token) where T : struct
        ...
        /// </summary>
        public static async Task<TResult?> MaxOrNull<TSource, TResult>(this IAsyncEnumerableObs<TSource> source, Func<TSource, TResult> selector, CancellationToken token) where TResult : struct
